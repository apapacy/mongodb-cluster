...
openssl req -new -x509 -days 1825 -extensions v3_ca -key /opt/mongodb/CA.key -out /opt/mongodb/CA.crt
cat /opt/mongodb/CA.crt > /opt/mongodb/CA.pem

openssl genrsa -out /opt/mongodb/certificate.key 4096
openssl req -new -key /opt/mongodb/certificate.key -out /opt/mongodb/certificate.csr  -extensions v3_ca
